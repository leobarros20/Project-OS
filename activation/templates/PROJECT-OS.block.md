<!-- BEGIN PROJECT-OS v0.7.1 — do not edit inside these markers; `project-os init` rewrites this block -->
...
`PROJECT-OS v0.7.1 ACTIVE`, automatic activation happened — follow what it says.
